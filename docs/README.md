...
Roles are intentionally explicit to reduce confusion and improve ownership. A **Project Manager (PM)** coordinates delivery — schedules, risks, dependencies, and communications — while a **Product Manager (PdM)** defines outcomes, prioritizes the backlog, and measures success. **Developers** implement features and tests and surface technical risks; the **QA Lead** owns the test strategy and quality gates; the **UX Designer** ensures designs are usable and accessible; the **Business Analyst** gathers and clarifies requirements; the **DevOps Engineer** owns CI/CD pipelines and deployment automation; and the **Support Specialist** surfaces customer feedback and manages customer communications. **Stakeholders** provide input and approvals at key milestones. A RACI mapping ties these roles to key artifacts and meetings. This clarity ensures the team always has a consistent source of truth.
...
- [RACI Mapping](octoacme-raci-mapping.md)
- [Cross-Functional Kickoff Checklist](octoacme-cross-functional-kickoff-checklist.md)
